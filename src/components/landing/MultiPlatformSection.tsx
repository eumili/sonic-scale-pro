export default function MultiPlatformSection() {
  const platforms = [
    { name: 'YouTube', color: '#EF4444', path: 'M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z' },
    ...
    <section className="py-16 sm:py-24">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
          YouTube. Spotify. Instagram. Un singur dashboard.
        </h2>
        <p className="text-muted-foreground max-w-2xl mx-auto text-lg mb-12">
          Conectează toate platformele și vezi totul dintr-un singur loc. Metrici unificate, recomandări cross-platform.
        </p>
        <div className="flex items-center justify-center gap-8 sm:gap-16">
          {platforms.map(p => (
            <div key={p.name} className="flex flex-col items-center gap-3">
              <div className="h-16 w-16 sm:h-20 sm:w-20 rounded-2xl flex items-center justify-center" style={{ backgroundColor: `${p.color}15` }}>
                <svg viewBox="0 0 24 24" className="h-8 w-8 sm:h-10 sm:w-10" fill={p.color}>
                  <path d={p.path} />
                </svg>
              </div>
